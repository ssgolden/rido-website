...
function DownloadCounter() {
  const { count, ref } = useCountUp(50000, { duration: 2500 });
  return <span ref={ref} className="font-bold text-rido-magenta">{count.toLocaleString()}+</span>;
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <ScrollReveal>
              ...
              <p className="text-lg text-white/50 max-w-lg mx-auto lg:mx-0 mb-4">Download the Rido app and start moving freely across Spain. Your first ride is waiting.</p>
              <p className="text-sm text-white/40 mb-8"><DownloadCounter /> riders and counting</p>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-8">
                <a href="#" aria-label="Download on the App Store" className="inline-block">
                  <div className="bg-white/10 hover:bg-white/15 border border-white/20 rounded-xl px-6 py-3 flex items-center gap-3 transition-all duration-200 hover:scale-105">
            ...
            <ScrollReveal delay={0.35}>
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6 text-white/40 text-sm">
            ...
            <ScrollReveal delay={0.5}>
              <div className="mt-6 flex items-center justify-center lg:justify-start gap-2 text-white/30 text-xs">
          ...
          <ScrollReveal delay={0.15} direction="right">
            <div className="flex justify-center lg:justify-end">
              <motion.div initial={{ y: 30 }} animate={{ y: [30, -10, 30] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="relative">
                <div className="relative w-[260px] sm:w-[280px] h-[520px] sm:h-[560px] rounded-[40px] border-4 border-white/20 bg-rido-navy shadow-2xl shadow-rido-magenta/20 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-full h-full bg-gradient-to-b from-rido-magenta/30 to-rido-navy flex flex-col items-center justify-center pt-10">
                      ...
                      <p className="text-white/40 text-sm mt-2">Move freely</p>
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-2 w-[200px]">
                        {["Map", "Ride", "Pay"].map((label) => (
                          <div key={label} className="h-[60px] rounded-lg bg-white/5 flex items-center justify-center text-white/30 text-xs">{label}</div>
                        ))}
                      </div>
                    </div>
                  </div>
