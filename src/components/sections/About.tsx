...
const en = {
  ...
  headingAfter: ", Built for the Costa del Sol",
  ...
  para2: "So we are building a fleet of shared e-scooters and e-bikes designed for the Costa del Sol's streets, weather and people. Every vehicle will be serviced in our own workshops, every ride insured, and every kilometre designed to replace a car trip.",
  milestones: [
...
const copy: Record<Locale, typeof en> = {
  ...
  es: {
    ...
    headingAfter: ", creado para la Costa del Sol",
    ...
    para2: "Así que estamos creando una flota de patinetes y bicis eléctricas compartidas pensada para las calles de la Costa del Sol, su clima y su gente. Cada vehículo se mantendrá en nuestros propios talleres, cada viaje irá asegurado y cada kilómetro está pensado para sustituir un trayecto en coche.",
    milestones: [
