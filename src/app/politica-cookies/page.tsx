  ...
  return (
    <LegalPage title="Cookie Policy" lastUpdated="July 2026">
      ...
      <ul>
        ...
        <li><strong>Analytics</strong>: Our analytics only runs after you have given your <strong>express consent</strong> through the banner displayed on your first visit (Article 6(1)(a) GDPR). Until you accept, no analytics code is loaded. The solution we use is additionally cookieless and processes only aggregated, anonymous data.</li>
      </ul>
      <p>
        You may withdraw your consent at any time as described below; withdrawal takes effect from that moment onwards.
      </p>
      ...
      <p>
        Because our analytics is consent-based and cookieless, and our fonts are self-hosted (no third-party requests), declining non-essential technologies does not degrade your experience on our website.
      </p>
