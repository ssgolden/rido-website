...
Current site imagery is placeholder-grade (a handful of product/lifestyle
JPGs in `public/images/`, a CSS-drawn phone mockup, no 3D). Everything
commissioned here replaces it.
...
Deliver into a folder structure matching `public/images/vehicles/`:
